...
public class CustomViewBehind extends ViewGroup {
	...
	private int mSecondMenuWidthOffset;
	...
	public void setWidthOffset(int i) {
		mWidthOffset = i;
		//mSecondMenuWidthOffset = i;
		requestLayout();
	}
	
	public void mSecondMenuWidthOffset(int i) {
		mSecondMenuWidthOffset = i;
		//requestLayout();
	}
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (mSecondaryContent != null)
			mSecondaryContent.layout(0, 0,width-mSecondMenuWidthOffset, height);
	}
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (mSecondaryContent != null)
		{
			...
			mSecondaryContent.measure(getChildMeasureSpec(widthMeasureSpec, 0, width-mSecondMenuWidthOffset), contentHeight);
		}
	}
	...
	public int getMenuLeft(View content, int page) {
		if (mMode == SlidingMenu.LEFT) {
			...
			case 2:
				if(mSecondaryContent!=null)
				{
					return mSecondaryContent.getLeft()+getSecondaryBehindWidth();
				}
				else
				{
					return content.getLeft() - getBehindWidth();
	...
	public int getSecondaryAbsRightBound(View content) {
		if (mMode == SlidingMenu.LEFT) {
			return content.getLeft();
		} else if (mMode == SlidingMenu.RIGHT || mMode == SlidingMenu.LEFT_RIGHT) {
	...
	public void drawShadow(View content, Canvas canvas) {
		...
		if (mMode == SlidingMenu.LEFT) {
			...
			if (mSecondaryShadowDrawable != null) {
				if (mSecondaryContent != null)
				{
					left = mSecondaryContent.getRight();
	...
	public void drawFade(View content, Canvas canvas, float openPercent,float SecondaryPercent) {
		...
		if (mMode == SlidingMenu.LEFT) {
			...
			if (mSecondaryContent != null)
			{
				...
				final int Secondaryalpha = (int) (mFadeDegree * 255 * Math.abs(1-SecondaryPercent));
				mFadePaint.setColor(Color.argb(Secondaryalpha, 0, 0, 0));
				left = mSecondaryContent.getRight()+mSecondMenuWidthOffset;
				right = mSecondaryContent.getRight() + getSecondaryBehindWidth()+mSecondMenuWidthOffset;
				canvas.drawRect(left, 0, right, getHeight(), mFadePaint);
			}
			else
			{
